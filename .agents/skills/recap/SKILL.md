---
name: recap
description: Quiz the learner on everything learned so far, going deeper wherever an answer is shaky. Use for a review/mastery session over already-completed concepts — not for teaching new material.
---
