---
name: continue
description: Resume the LLM course from the learner's saved progress. Use when a `.progress/progress.md` already exists and the learner wants to pick up where they left off.
---
