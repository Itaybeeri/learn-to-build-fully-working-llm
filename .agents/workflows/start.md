...
## Step 1 — Onboard (ask questions & stop)
...
3. **Ask onboarding questions:** what should I call you? how comfortable are you
   with math and programming (total beginner is welcome)? any preferred pace/depth?
4. **Stop execution.** Do not write progress files or teach yet.

## Step 2 — Create the progress files (upon receiving response)

Once the learner replies, create **`.progress/progress.md`** with their actual answers and the starting pointer, e.g.:
